    ...
    return (
        <div className="relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14">
                ...
                <button className="w-full rounded bg-[#e50514] py-3 font-semibold" onClick={() => setLogin(true)}>Log In</button>
                <div className="text-[grey]">
                    New to Netflix?{' '}
                    <button onClick={() => setLogin(false)} type="submit" className="cursor-pointer text-white/80 hover:underline hover:text-white">
                        Sign up now
                    </button>
                </div>
            </form>
